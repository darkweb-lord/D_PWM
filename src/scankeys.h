...
void SCAN_KEYS() {
    ...
    if (ENTER_KEYCOUNT > 1) {
        ...
        if (OPMENU_PAGE == 3 || OPMENU_PAGE == 5 || (OPMENU_PAGE > 23 && OPMENU_PAGE < 28)) {
            MAXVALUE = 9999;
            MIN = -9999;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 2) {
            MAXVALUE = 9999;
            MIN = -9999;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        } else if (OPMENU_PAGE == 1 || OPMENU_PAGE == 4 || OPMENU_PAGE == 10 || OPMENU_PAGE == 11) {
            MAXVALUE = 9999;
            MIN = -9999;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        } else if (OPMENU_PAGE == 6 || OPMENU_PAGE == 125 || OPMENU_PAGE == 134 || OPMENU_PAGE == 141 || OPMENU_PAGE == 146) {
            MAXVALUE = 32000;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE > 151 && OPMENU_PAGE < 158) {
            MAXVALUE = 32000;
            MIN = -9999;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 7) {
            MAXVALUE = 32000;
            MIN = 0;
            if (FilteredFreq <= 3000.0)DECIMAL_POINT = 1;
            else DECIMAL_POINT = 2;
        } else if (OPMENU_PAGE == 8) {
            MAXVALUE = 32000;
            MIN = 0;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 9) {
            MAXVALUE = 32000;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 12 || (OPMENU_PAGE > 45 && OPMENU_PAGE < 52) || OPMENU_PAGE == 148) {
            MAXVALUE = 1;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 52) {
            MAXVALUE = 9999;
            MIN = -9999;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE > 52 && OPMENU_PAGE < 57) {
            MAXVALUE = 1000;
            MIN = 0;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 13) {
            MAXVALUE = 9999;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 14 || OPMENU_PAGE == 149) {
            MAXVALUE = 2;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 17) {
            MAXVALUE = 9999;
            MIN = 0;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        } else if (OPMENU_PAGE == 16) {
            MAXVALUE = 30000;
            MIN = 0;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        } else if (OPMENU_PAGE == 116 || OPMENU_PAGE == 117 || OPMENU_PAGE == 144 || OPMENU_PAGE == 150 || OPMENU_PAGE == 147) {
            MAXVALUE = 9999;
            MIN = 0;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 18) {
            MAXVALUE = 5;
            MIN = 1;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 19) {
            MAXVALUE = 11;
            MIN = 1;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 20) {
            MAXVALUE = 100;
            MIN = 2;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 110 || OPMENU_PAGE == 151) {
            MAXVALUE = 5;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE >= 21 && OPMENU_PAGE <= 23) {
            MAXVALUE = 9999;
            MIN = -9999;
            DECIMAL_POINT = 2;
        } else if (OPMENU_PAGE == 28 || OPMENU_PAGE == 29 || OPMENU_PAGE == 111 || OPMENU_PAGE == 112 || OPMENU_PAGE == 120) {
            MAXVALUE = 3;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE >= 30 && OPMENU_PAGE <= 36) {
            MAXVALUE = 3000;
            MIN = 0;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE >= 37 && OPMENU_PAGE <= 43) {
            MAXVALUE = 3000;
            MIN = -3000;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 71 || OPMENU_PAGE == 85 || OPMENU_PAGE == 92 || OPMENU_PAGE == 75 || OPMENU_PAGE == 89 || OPMENU_PAGE == 96 || OPMENU_PAGE == 123 || OPMENU_PAGE == 132 || OPMENU_PAGE == 126 || OPMENU_PAGE == 135) {
            MAXVALUE = 1000;
            MIN = -1000;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 72 || OPMENU_PAGE == 86 || OPMENU_PAGE == 93 || OPMENU_PAGE == 130 || OPMENU_PAGE == 131 || OPMENU_PAGE == 121 || OPMENU_PAGE == 122) {
            MAXVALUE = 7000;
            MIN = 0;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 76 || OPMENU_PAGE == 90 || OPMENU_PAGE == 97 || OPMENU_PAGE == 158 || OPMENU_PAGE == 159) {
            MAXVALUE = 9999;
            MIN = -9999;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 73 || OPMENU_PAGE == 80 || OPMENU_PAGE == 87 || OPMENU_PAGE == 94 || OPMENU_PAGE == 124 || OPMENU_PAGE == 133 || OPMENU_PAGE == 139 || OPMENU_PAGE == 142) {
            MAXVALUE = 9999;
            MIN = 1;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 74 || OPMENU_PAGE == 88 || OPMENU_PAGE == 95) {
            MAXVALUE = 9999;
            MIN = 0;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 119 || OPMENU_PAGE == 128) {
            MAXVALUE = 15;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 78) {
            MAXVALUE = 1000;
            MIN = -1000;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        } else if (OPMENU_PAGE == 79) {
            MAXVALUE = 7000;
            MIN = 0;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        } else if (OPMENU_PAGE == 81) {
            MAXVALUE = 9999;
            MIN = 0;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        } else if (OPMENU_PAGE == 82) {
            MAXVALUE = 1000;
            MIN = -1000;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        } else if (OPMENU_PAGE == 83) {
            MAXVALUE = 9999;
            MIN = -9999;
            DECIMAL_POINT = CALIBRATION[DPSELECT];
        }
        else if (OPMENU_PAGE == 129) {
            MAXVALUE = 4;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 136) {
            MAXVALUE = 2;
            MIN = 1;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 137) {
            MAXVALUE = 32000;
            MIN = 1;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 143) {
            MAXVALUE = 20000;
            MIN = 1;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 145) {
            MAXVALUE = 9999;
            MIN = 15;
            DECIMAL_POINT = 0;
        } else if (OPMENU_PAGE == 138) {
            MAXVALUE = 9999;
            MIN = 1;
            DECIMAL_POINT = 1;
        } else if (OPMENU_PAGE == 116) {
            MAXVALUE = 32000;
            MIN = 0;
            DECIMAL_POINT = 0;
        } else {
    ...
    if (KEY_PRESSED == TRUE && KEY_OPRN_OVER == FALSE) {
        ...
        switch (KEY) {
            ...
            case SET_KEY:
                ...
                if (OPMENU_PAGE > 0 && SETPAGE == 1 && ENTER_KEYCOUNT == 0) {
                    ENTER_KEYCOUNT = 1;
                    CURSOR = TRUE;
                }
                break;
            ...
            case ENTER_KEY:
                ...
                if (ENTER_KEYCOUNT == 3) {
                    ...
                    {
                        if (CALIBRATION[ACCESSCODE] == MPASSWORD || CALIBRATION[ACCESSCODE] == CALIBRATION[PASSWORD]) {
                            MAX_PAGE = 160;
                            PASS = CALIBRATION[ACCESSCODE];
                    ...
                    if (OPMENU_PAGE == 149)Precision_Updation();
