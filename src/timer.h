...
#define TIMER_CLK_DIV32			0x03	///< Timer clocked at F_CPU/64
#define TIMER_CLK_DIV64		    0x04	///< Timer clocked at F_CPU/256
...
#define TIMER2PRESCALE		TIMERRTC_CLK_DIV1024	///< timer 2 prescaler default
